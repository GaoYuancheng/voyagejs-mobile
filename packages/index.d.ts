...
export { default as Affix } from './components/Affix/index.vue'
export * from './components/Affix/index.vue'
export { default as DescriptionIcon } from './components/DescriptionIcon/index.vue'
export * from './components/DescriptionIcon/index.vue'
export { default as StatisticsCard } from './components/StatisticsCard/index.vue'
export * from './components/StatisticsCard/index.vue'
export { default as FormCard } from './components/FormCard/index.vue'
export * from './components/FormCard/index.vue'
